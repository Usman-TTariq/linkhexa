...
const socials = [
  { name: "Facebook", href: "https://www.facebook.com/linkhexa", icon: (
  ...
  { name: "Instagram", href: "https://www.instagram.com/link_hexa/", icon: (
  ...
  { name: "X", href: "https://x.com/linkhexa25363", icon: (
